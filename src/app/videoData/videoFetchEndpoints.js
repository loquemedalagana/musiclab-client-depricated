...
export const getVideoDataFromPlayList = (data, hd) => data ? data.items.map(item => {        
  return ({
    ...
    thumbnail: hd && item.snippet.thumbnails.standard ? item.snippet.thumbnails.standard.url : item.snippet.thumbnails.high.url,
