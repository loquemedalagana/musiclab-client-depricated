...
export const YOUTUBE_PLAYLIST_ITEMS_API =
  "https://www.googleapis.com/youtube/v3/playlistItems";
export const YOUTUBE_CHANNEL_ITEMS_API =
  "https://www.googleapis.com/youtube/v3/channels";
export const YOUTUBE_VIDEO_ITEMS_API =
...
export const getPlayListURL = (playlistId, maxResults) =>
  `${YOUTUBE_PLAYLIST_ITEMS_API}?part=snippet${comma}CcontentDetails&playlistId=${playlistId}&maxResults=${maxResults}&key=${YoutubeApiKey}`;
...
export const getVideoDataFromPlayList = (data, hd) =>
  data
    ? data.items.map((item) => {
        return {
